...
def cpm():
	...
	#early_start early start time of each activity
	#early_finish early finish time of each activity
	#late_start late start time of each activity
	...
	#critic_activity critical activities of the project
	return early_start,early_finish,late_start,late_finish,free_slack,total_slack,critic_activity
